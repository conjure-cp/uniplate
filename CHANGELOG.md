...
- *(perf)* remove clone in `Tree<T>::list` and `T: Clone` type bound ([#120](https://github.com/conjure-cp/uniplate/pull/120))

### Other

- remove disabled no-uniplate-attr derive test ([#118](https://github.com/conjure-cp/uniplate/pull/118))
- *(uniplate-derive)* remove some clones in derive macro ([#121](https://github.com/conjure-cp/uniplate/pull/121))

## [0.4.5](https://github.com/conjure-cp/uniplate/compare/v0.4.4...v0.4.5) - 2025-11-01

### Fixed

- inspect tree children for zipper has_down

## [0.4.4](https://github.com/conjure-cp/uniplate/compare/v0.4.3...v0.4.4) - 2025-10-21

### Other

- *(deps)* bump the all group across 1 directory with 5 updates
- Added existential functions - has up, down, left, right ([#104](https://github.com/conjure-cp/uniplate/pull/104))
